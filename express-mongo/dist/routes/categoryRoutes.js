...
router.post("/", authenticate, authorize("ADMIN"), validate(categorySchema), asyncHandler(categoryController.createCategory));
router.put("/:id", authenticate, authorize("ADMIN"), validate(categorySchema), asyncHandler(categoryController.updateCategory));
